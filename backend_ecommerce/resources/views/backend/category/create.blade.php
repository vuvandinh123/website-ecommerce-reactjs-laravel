    ...
    <a href="{{ route('category.index') }}" class="fs-6">Quay lại</a>
        ...
        <form action="{{ route('category.store') }}" id="create" method="post"enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <label for="" class="form-label">parent <span class="text-danger">*</span></label>
                ...
                <div class="col-md-6">
                    <label for="" class="form-label my-2">Meta key <span
                ...
                <div class="col-md-6 image-create">
                    <label for="" class="form-label my-2 me-2">image:</label>
                ...
                <div class="col-md-12">
                    <label for="" class="form-label my-2">meta description <span
                            class="text-danger">*</span></label>
                    <textarea
                ...
                <div class="col-md-12">
                    <button class="btn btn-success px-3 w-100 mt-5" type="submit">ADD</button>
                </div>
            </div>
        </form>
    </div>
