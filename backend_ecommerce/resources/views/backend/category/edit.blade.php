...
@section('content')
    <div class="container-fluid py-4">
        <div class="bg-white border-radius-2xl p-5">
            ...
            <form action="{{ route('category.update', ['category' => $category->id]) }}" id="create"
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" value="{{ $category->metakey }}"
                            placeholder="ví dụ: sản phẩm đến từ tương lai" class="form-control" name="metakey"
                            id="metakey">
                        <span class="text-danger alert" style="font-size: 12px"></span>
                    </div>
                    <div class="col-md-6 image-create">
                        ...
                        <input type="file" value="{{ $category->image }}" placeholder="ví dụ: 10" class="form-control"
                            name="image" id="">
                        <input type="radio" name="chon" id="url">
                        <input type="text" value="{{ $category->image }}" class="form-control" placeholder="URL"
                            name="urlimage">
                    ...
                    <div class="col-md-6">
                        ...
                        <select name="status" class="form-select" id="status">
                            <option @if ($category->status == 2) selected @endif value="2">Hiện</option>
                            <option @if ($category->status == 1) selected @endif value="1">Ẩn</option>
                        </select>
                        <span class="text-danger alert" style="font-size: 12px"></span>
                    </div>
                    <div class="col-md-12">
...
@section('script')
    <script>
        $(document).ready(function() {
            validateInput(['#name', '#sort_order', '#parent_id', '#metakey', '#metades'],
