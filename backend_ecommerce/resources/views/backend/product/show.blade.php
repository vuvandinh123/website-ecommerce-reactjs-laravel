            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0 d-flex justify-content-between">
                        ...
                        <a class="btn " href="{{ route('product.edit',['product'=>request()->route('product')]) }}">Sửa</a>
                    </div>
                    <div class="card-body px-3 pt-0 pb-2 row">
                        <div style="flex-wrap: wrap" class="col-4 d-flex">
                            @foreach ($product->images as $item)
                                <div class="">
                                    <img style="width: 180px; height: 180px" class="" src={{ asset('images/' . $item->image_url) }} alt="">
                                </div>
                            @endforeach
                        </div>
                        <div class="p-0 col-8 ">
