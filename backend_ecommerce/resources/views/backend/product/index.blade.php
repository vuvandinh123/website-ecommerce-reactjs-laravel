                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        ...
                                                        <img src="{{ asset('images/' . (count($product->images) > 0 ? $product->images[0]->image_url : 'error.png')) }}"
                                            ...
                                            <td class="align-middle text-center">
                                                <i style="cursor: pointer"
                                                    class="p-3 fa-solid text-success setStatus fs-4 @if ($product->status == 2) fa-toggle-on
                                                    @else fa-toggle-off @endif"
                                                    data-id="{{ $product->id }}"></i>
                                                <a href="{{ route('product.image', ['id' => $product->id]) }}"
                                                    class="" data-toggle="tooltip" data-original-title="Edit user">
                                                ...
                                                <a class="py-2 delete" style="cursor: pointer"
                                                    data-id="{{ $product->id }}">
                                            ...
                                            <td class="align-middle ">
                                                <span class="text-secondary font-weight-bold text-xs" data-toggle="tooltip"
                                                    data-original-title="Edit user">
                                                    <input type="checkbox" value="{{ $product->id }}" name="delete[]"
                                                        class="deletes" id="">
                                                </span>
                                            </td>
                                        </tr>
                            ...
                            <ul style="list-style: none;" class="d-flex mt-3">
                                ...
                                <li class="mx-2"> <a class="text-success" href="{{ route('product.create') }}">Tạo
                                        mới</a></li>
