...
const Cart = ({ cart, setCart, cartRef }) => {
  ...
  return (
    <div
      className={`fixed ${
        cart && " !opacity-100 !visible "
      } opacity-0 invisible top-0 left-0 right-0  bottom-0 z-50 bg-[#000000ad]`}
    >
      <div
        ref={cartRef}
        className={` ${cart && "lg:!w-[450px]"} overflow-hidden transition-all duration-300  w-[100%] lg:w-0  bg-white absolute right-0 h-full`}
      >
        ...
        <div className="overflow-y-scroll max-h-[41%]">
          {cartList.map((item, index) => {
            return (
              <div key={index} className="flex gap-3  items-start p-5 border-b">
                <div className="w-28 p-2 relative min-h-[100px]">
                  <ImageLoader
                    className=""
                    src={
                      "https://demo-uminex.myshopify.com/cdn/shop/products/products_23_1_small.jpg?v=1672305891"
                    }
                    alt={""}
                  />
                </div>
                <div className="">
                  ...
                  <div className="">
                    <div className="flex gap-2 items-center w-44">
                      <button className="px-2 group py-1 border ">
                        <img src={minus} alt="" />
                      </button>
                      <input
                        defaultValue={"01"}
                        ...
                        type="text"
                      />
                      <button className=" px-2 py-1 border group">
                        <img src={plus} alt="" />
                      </button>
                    </div>
                  </div>
        ...
        <div className="py-5 mt-3 px-5  border-b">
          <div className=" relative">
            <div className="ship w-2/3 h-[6px]  rounded-md bg-red-500"></div>
        ...
        <div className="bg-[#F1F5F6] p-4">
          <div className="flex items-center justify-between gap-10">
            ...
            <div className="my-2 text-end">
              ...
              <p className="text-red-600 text-[18px] font-bold">$1,886.70</p>
            </div>
          </div>
          <div className="mt-5 h-[100vh]">
            <button className="w-full  hover:bg-[#fff457] duration-300 hover:text-white transition-all bg-white border rounded-full py-3 font-bold mb-3">
              VIEW CART
            </button>
            <button className="w-full text-white transition-all duration-300 hover:bg-[#ff5e5e] border rounded-full font-semibold bg-[#2049ff] py-3">
              CHECK OUT
            </button>
          </div>
        </div>
