                  ...
                  <div className="relative group p-1">
                    <div className="group/image w-[150px] md:w-[180px]">
                      <a href="" className="block relative min-h-[160px]">
                        <ImageLoader src="https://demo-uminex.myshopify.com/cdn/shop/products/products_35_2.jpg?v=1678075833&width=360" className={`group-hover/image:opacity-0 transition-all duration-400 object-contain`} alt={"image"}/>
                        <img
                          className=" group-hover/image:!opacity-100 opacity-0 transition-all duration-400 absolute top-0 left-0"
                          src="https://demo-uminex.myshopify.com/cdn/shop/products/products_34_2.jpg?v=1678075516&width=360"
                          alt=""
                        />
                      </a>
                    </div>
                  ...
                  <div className="py-5 px-2 flex flex-col">
                    <h3 className="">
                      <a className="font-[400]" href="">
                        Samsung Galaxy S20 FE 8GB/256GB Blue
                      </a>
                    </h3>
